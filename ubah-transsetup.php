...
$id=$_GET['id'];
$sql=$koneksi->query("select * from transsetup where id='$id'");
...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div >
                            <h1><center><label class="label label-success">Edit Setting Transaksi Rutin</label></center></h1>                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <select name="accdebet" class="form-control show-tick">
									...
									?>
									<option value="<?php echo $tabkira['CNO_KIRA'];?>" <?php if($tampil['accdebet']==$tabkira['CNO_KIRA']) echo "selected";?>><?php echo $tabkira['CNO_KIRA'].' - '.$tabkira['CNAMA_KIRA'];?></option>
									<?php
									}
									?>
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <select name="acckredit" class="form-control show-tick">
									...
									?>
									<option value="<?php echo $tabkira1['CNO_KIRA'];?>" <?php if($tampil['acckredit']==$tabkira1['CNO_KIRA']) echo "selected";?>><?php echo $tabkira1['CNO_KIRA'].' - '.$tabkira1['CNAMA_KIRA'];?></option>
									<?php
									}
									?>
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" value="<?php echo $tampil['cket'];?>" name="cket" class="form-control" />
                            </div>
                        </div>
...
$ckredit=$kredit['CNAMA_KIRA'];
	...
	$sql=$koneksi->query("update transsetup set accdebet='$accdebet',acckredit='$acckredit',cdebet='$cdebet',ckredit='$ckredit',cket='$cket' where id='$id'");
