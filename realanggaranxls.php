...
header("Content-type: application/vnd-ms-excel");
	header("Content-Disposition: attachment; filename=REALISASI_RAPB.xls");
...
<table border="1" width="100%" style="border-collapse: collapse;">
	...
	<caption><h2>REALISASI ANGGARAN PENDAPATAN DAN BIAYA</h2>
	...
	<tbody>
		<?php
			...
			$subtotalanggaran=0;
			$subtotalrealisasi = 0;
			$sql=$koneksi->query("select mstanggaran.kode,mstanggaran.deskripsi,anggaran.pertahunawal,anggaran.pertahunubah,sum(jurnal.idramount) as realisasi from mstanggaran left join jurnal on mstanggaran.kode=jurnal.cproject and extract(year from jurnal.dtgl_trans)='$tahun' and extract(year_month from jurnal.dtgl_trans)<='$ymproc' and jurnal.ctransflag='TR' and jurnal.cdebkred='D',anggaran where mstanggaran.kode=anggaran.kode and anggaran.tahun='$tahun' and mstanggaran.kodekel='$kodekel' group by mstanggaran.kode");
			...
			<td align="right"><b><?php echo number_format($subtotalrealisasi/$subtotalanggaran*100,2,',','.');?></b></td>
			<?php } ?>
			...
			<td align="right"><b><?php echo number_format($realpendapatan/$angpendapatan*100,2,',','.');?></b></td>
			</tr>
			<tr>
			...
			<td align="right"><b><?php echo number_format($realbiaya/$angbiaya*100,2,',','.');?></b></td>
			</tr>
			<tr>
