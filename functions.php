...
{
<<<<<<< HEAD
	//echo "<script type='text/javascript'>alert('jurnal');</script>";	


	$cjurntype = 'JU';
	$ctransflag = 'TR';
	$lautho = 'Y';
	//$gabung=$vcket.$vcnokira.$vcdebkred.str($vnidramount).$vcuser;

	//echo "<script type='text/javascript'>alert('$vcnokira');</script>";
	//$nres1=mysqli_query($koneksi,"insert into jurnal (NNO_TRANS,DTGL_TRANS,CKET,CNO_KIRA,CDEBKRED,IDRAMOUNT,CJURNTYPE,CTRANSFLAG,LAUTHO,CUSER) values ('$vnnotrans','$vdtgl','$vcket','$vcnokira','$vcdebkred','$vnidramount','JU','TR','Y','$vcuser')");
	//$nres1=$koneksi->query("insert into jurnal (CNO_KIRA) values ('$vcnokira')");
=======
